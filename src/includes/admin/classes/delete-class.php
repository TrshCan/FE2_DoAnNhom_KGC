...
$id = (int)$data['id'];
$targetDir = BASE_URL_upload_image . "/classes/";
...
$stmt = $conn->prepare("SELECT icon FROM classes WHERE id = ?");
...
if ($row = $result->fetch_assoc()) {
    ...
    error_log("No class found with ID: $id");
}
...
if ($icon) {
    ...
    error_log("No icon associated with class ID: $id");
}

...
$stmt = $conn->prepare("SELECT icon FROM regions WHERE id = ?");
...
if ($row = $result->fetch_assoc()) {
    ...
    error_log("No region found with ID: $id");
}
...
if ($icon) {
    ...
    error_log("No icon associated with region ID: $id");
}

// Delete the region record from the database

...
export default function HeroSkillManager() {
  ...
  useEffect(() => {
    const filtered = heroSkills.filter(
      (skill) =>
        skill.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
        (skill.description && skill.description.toLowerCase().includes(searchQuery.toLowerCase())) ||
        (skill.type && skill.type.toLowerCase().includes(searchQuery.toLowerCase()))
    );
    setFilteredSkills(filtered);
  }, [searchQuery, heroSkills]);
  ...
  const handleSubmit = async (isEdit = false) => {
    const url = isEdit ? "update-hero-skill.php" : "add-hero-skill.php";
    ...
    await fetch(`${BASE_URL}/src/includes/admin/hero-skills/${url}`, {
      method: "POST",
      body: formData,
    });
  ...
  const handleEdit = (skill) => {
    setForm(skill);
    setIconPreview(skill.icon ? `${BASE_URL_upload_image}/hero-skills/${skill.icon}` : null);
    setIconFile(null);
      ...
      <div className="card shadow-sm border-0">
        <div className="card-body p-4">
          <div className="d-flex justify-content-between align-items-center mb-4">
            ...
            >
              Thêm Kỹ năng Hero Mới
            </button>
            <input
              type="text"
              className="form-control form-control-sm w-50"
              placeholder="Tìm kiếm theo tên, mô tả hoặc loại..."
              value={searchQuery}
            ...
            <table className="table table-hover table-bordered table-sm">
              <thead className="table-dark">
                <tr>
                  ...
                  <th scope="col" className="text-center name-column">Hero</th>
              ...
              <tbody>
                {filteredSkills.map((skill) => (
                  <tr key={skill.id}>
                    <td className="text-center align-middle">{skill.id}</td>
                    <td className="text-center align-middle name-cell">{skill.hero_name || skill.hero_id}</td>
                    ...
                    <td className="text-center align-middle">
                      {skill.icon ? (
                        <img
                          src={`${BASE_URL_upload_image}/hero-skills/${skill.icon}`}
                          alt={skill.name}
            ...
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title">Thêm Kỹ năng Hero Mới</h5>
                  <button
                    type="button"
                    className="btn-close"
          ...
          >
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title">Sửa Kỹ năng Hero</h5>
                  <button
                    type="button"
                    className="btn-close"

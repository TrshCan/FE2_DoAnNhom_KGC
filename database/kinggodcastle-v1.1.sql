...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 26, 2025 at 09:26 PM
...
INSERT INTO `heroes` (`id`, `name`, `region_id`, `class_id`, `title`, `description`, `icon`, `illustration`) VALUES
(1, 'Luniare', 2, 2, 'Blue Moonlight', 'Coming form the north where the Blue Moon rises, Luniare endlessly yearned for the Moon that rose every night, coming to harness its beauty to bless others.', 'Unit_10230.png', 'Unit_Illust_10230_02.png'),
(2, 'Shelda', 5, 4, 'Shield of Knights', 'Shelda always stands against enemies at the front line of the battlefield to honor her father, a legendary war hero.', 'Unit_10000_00.png', 'Unit_Illust_10000_00.png'),
(3, 'Evan', 5, 3, 'Sword of Valor', 'Evan, a talented swordman and tactician, ascended to the position of Knight Commander at such a tender age.', 'Unit_10030.png', 'Unit_Illust_10030.png'),
(4, 'Draco', 4, 6, 'Half-Dragon', 'Born between a dragon and a human, Draco cannot wield the full power of a dragon, but his might is still quite formidable.', 'Unit_10080_01.png', 'Unit_Illust_10080.png'),
...
(2, 'admin@email.com', 'root', 'bob_builder', 'admin', NULL),
(3, 'charlie@example.com', 'randompass789', 'charlie_chap', 'user', NULL),
(4, 'admin@gmail.com', '$2y$10$ARZaieEfuZIPLonJvHYJCO6ccNKYIgk6bTjSC3ggepMz2RY.l/gDS', 'username 1', 'user', NULL);
...
--
-- Indexes for table `enemy_base_stats`
--
...
--
-- Indexes for table `enemy_skills`
--
